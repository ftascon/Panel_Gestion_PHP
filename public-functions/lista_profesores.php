...
function get_profesores($id_user) {
    $list_alumnos = '';
    ...
    for ($i = 0; $i < count($profesores_data); $i++) {
        ...
        $list_alumnos .= '<tr>
                        ...
                        <td class="passphrase_users">
                            <span>' . $profesores_data[$i]["username_users"] . '</span>
                        </td>
                        <td class="passphrase_users">
                            <span>' . $profesores_data[$i]["passphrase_users"] . '</span>
                        </td>
                        <td class="text-center">
                            <div class="btn-group">
...
<div class="page-content">
    <div class="page-content-inner">
        ...
        <!-- alumnos (table) -->
        <div class="block">
            <h6 class="heading-hr"><i class="icon-people"></i>Lista de profesores ' . $btn_pass . '</h6>
                ...
                <table class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th>Contacto</th>
                            <th>Pais</th>
                            <th class="passphrase_users">Usuario</th>
